...
start_yourappname() {
    #
    export LD_LIBRARY_PATH=$HelloMiyoo/lib:/lib:/config/lib:/mnt/SDCARD/miyoo/lib:/mnt/SDCARD/.tmp_update/lib:/mnt/SDCARD/.tmp_update/lib/parasyte:/sbin:/usr/sbin:/bin:/usr/bin
    ...
    ./HelloMiyoo > /dev/pts/0 2>&1
}

main() {
    curvol=$(get_curvol) # grab current volume
    start_your_app_here # call the function to start the app
}
